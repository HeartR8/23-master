...
object BDecoderInstances:
   ...
   */
  given Decoder[IllegalArgumentDecoderError.type, Boolean] = Decoder.attempt(_.toBoolean).leftMap(_ => IllegalArgumentDecoderError)
  ...
  given Decoder[InvalidDegreesFahrenheitValue.type, DegreesFahrenheit] = {
    summon[Decoder[NumberFormatDecoderError.type, Int]].bimap(_: NumberFormatDecoderError.type)
  }
